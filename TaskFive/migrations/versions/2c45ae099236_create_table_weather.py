...
Revision ID: 2c45ae099236
Revises: 
Create Date: 2023-05-09 18:55:28.371317
...
def upgrade():
    ...
    op.drop_table('weather_weatherinfo')
...
def downgrade():
    ...
    op.create_table('weather_weatherinfo',
    sa.Column('id', sa.BIGINT(), sa.Identity(always=False, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), autoincrement=True, nullable=False),
    ...
    sa.PrimaryKeyConstraint('id', name='weather_weatherinfo_pkey')
    )
